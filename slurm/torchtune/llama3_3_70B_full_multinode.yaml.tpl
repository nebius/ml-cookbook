...
tokenizer:
  ...
  path: ${root_dir}/models/Llama-3.3-70B-Instruct/original/tokenizer.model
  max_seq_len: 1024
...
checkpointer:
  ...
  checkpoint_dir: ${root_dir}/models/Llama-3.3-70B-Instruct/
  checkpoint_files:
...
optimizer:
  ...
  lr: 2e-5
  fused: False  # Must be False when using tensor parallelism
